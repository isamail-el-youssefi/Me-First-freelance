...
const Packages = ({ limit }: { limit?: number }) => {
  ...
  return (
    <section className="max-container padding-container md:pt-20">
      <AnimatedSection>
        <div className="flex flex-col justify-center items-center text-center">
          <h1 className="md:text-3xl text-2xl font-semibold uppercase pb-12 text-amber-900">
            {t(TITLES.Popular)}
          </h1>
        </div>
      </AnimatedSection>
        ...
        {limit && (
          <div className="text-center mt-8">
            ...
            >
              ...
              <ArrowRight className="inline-block ml-2 text-amber-800" />
            </a>
          </div>
        )}
      </AnimatedSection>
