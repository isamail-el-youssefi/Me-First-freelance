...
export const allPackages = [
  {
    ...
    heading: "packages.package1.heading",
    text: "packages.package1.text",
    width: 1920,
    height: 1280,
    link: "/trips/1",
    duration: "5 Days",
  ...
  },
  {
    ...
    heading: "packages.package2.heading",
    text: "packages.package2.text",
    width: 500,
    height: 300,
    link: "/trips/2",
    duration: "3 Days",
  ...
  },
  {
    ...
    imageSrc: "/test2.jpg",
    imageAlt: "kasbah",
    heading: "packages.package3.heading",
    text: "packages.package3.text",
    width: 1920,
    height: 1280,
    link: "/trips/3",
    duration: "6 Days",
  ...
  },
  {
    ...
    imageSrc: "/oasis2.jpg",
    imageAlt: "kasbah",
    heading: "packages.package4.heading",
    text: "packages.package4.text",
    width: 1920,
    height: 1280,
    link: "/trips/4",
    duration: "2 Days",
